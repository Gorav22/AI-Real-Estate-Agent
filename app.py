...
def main():
    ...
    with st.sidebar:
        ...
        model_id = st.selectbox(
            "Choose Gemini Model",
            options=["gemini-1.5-flash", "gemini-1.5-flash-8b","gemini-2.0-flash-exp"],
            help="Select the AI model to use. Choose gemini-2.0-flash-exp if your api doesn't have access to gemini-2.0-flash or gemini-2.0-flash-8b"
        )
